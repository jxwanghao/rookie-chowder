package com.jxwanghao.rookie.commons.plugin.pagehelper.sqlsource;

import com.jxwanghao.rookie.commons.plugin.pagehelper.PageHelper;
import com.jxwanghao.rookie.commons.plugin.pagehelper.parser.OrderByParser;
...
public class PageStaticSqlSource extends PageSqlSource {
	...
	protected BoundSql getPageBoundSql(Object parameterObject) {
		...
		return new BoundSql(configuration, tempSql, localParser.get().getPageParameterMapping(configuration, original.getBoundSql(parameterObject)),
				parameterObject);
	}
