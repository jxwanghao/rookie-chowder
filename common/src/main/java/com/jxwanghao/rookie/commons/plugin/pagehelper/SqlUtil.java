package com.jxwanghao.rookie.commons.plugin.pagehelper;

import com.yyfax.oss.common.plugin.pagehelper.parser.Parser;
import com.yyfax.oss.common.plugin.pagehelper.parser.impl.AbstractParser;
import com.yyfax.oss.common.plugin.pagehelper.sqlsource.*;
...
/**
 * MybatisSql工具，获取分页和count的MappedStatement，设置分页参数
 *
...
public class SqlUtil implements Constant {
	...
	private boolean isQueryOnly(Page page) {
		return page.isOrderByOnly() || ((page.getPageSizeZero() != null && page.getPageSizeZero()) && page.getPageSize() == 0);
	}
